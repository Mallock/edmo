...
/**
 * Which part of the briefing carries this scene. 12 entries.
 *
 ...
 */
const COMMS_ANCHOR: readonly string[] = [
  'This time, prefer the FACTION BOARD as the driver — who runs the place, who is climbing.',
  'This time, prefer a STATION by name as the driver.',
  'This time, prefer a SIGNAL out there as the driver — a site, a beacon, a zone.',
  'This time, prefer DISTANCE as the driver — how far everything is from everything.',
  'This time, prefer the SECURITY rating as the driver.',
  'This time, prefer the ECONOMY as the driver — what this system does for a living.',
  'This time, prefer TRAFFIC as the driver — who else is on approach, who is leaving.',
  "This time, prefer the COMMANDER'S presence as the driver, still never addressing them.",
  'This time, prefer something INVENTED as the driver — a ship, a person, a cargo of your own making, set against the real backdrop.',
...
export const commsAnchorLean = (rotate: number): string => pick(COMMS_ANCHOR, rotate);
